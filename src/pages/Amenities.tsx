...
import { Coffee, Dumbbell, Utensils, Wine, Clock, Car, Plane, Car as CarIcon, MapPin, Waves, Users, Music, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Coffee key={0} />, <Dumbbell key={1} />, <Coffee key={2} />, <Coffee key={3} />],
